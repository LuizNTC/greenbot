...
const basePromptParts = [
    ...
    "Para computador, o cliente pode utilizar o IPTV SMARTERS para utilizar (ele é compatível como aplicativo ou web player diretamente no navegador) no site https://www.iptvsmarters.com/",
    "Em Iphone o cliente pode utilizar o SMARTERS PLAYER LITE disponível na AppleStore",
    ...
    "Para SmartTVs Roku, seja ela de qualquer marca, pode utilizar o aplicativo XcloudTV. Para usar o XcloudTV basta colocar o provider como 'space1', seu usuário e senha",
